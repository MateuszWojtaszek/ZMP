...
namespace geom
{
  ...
  Sgn(double Val)
  {
    return Val > ERR_DOUBLE ? 1 : Val < -ERR_DOUBLE ? -1
                                                    : 0;
  }
